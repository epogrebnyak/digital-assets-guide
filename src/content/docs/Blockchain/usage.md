...
- Cryptocurrencies <!-- hover: BTC (2009), ETH (2015), altcoins -->
- Memecoins <!-- hover: CashCat (2026), Shiba Inu (2020), Dogecoin (2013) -->
- Prediction markets <!-- hover: Polymarket (2020), Kalshi (2021) -->
...
- Wireless networks <!-- hover: Helium -->
- Storage <!-- hover: Filecoin, Arweave -->
- Compute <!-- hover: Render, Akash -->
- Supply chain and provenance <!-- hover: VeChain, IBM Food Trust -->

## Social and governance

- Identity <!-- hover: ENS, World ID, Civic -->
- Reputation and credentials <!-- hover: Gitcoin Passport, EAS, Sismo -->
- Voting rights <!-- hover: Aragon, Snapshot, Tally -->
